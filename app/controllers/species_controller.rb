class SpeciesController < ApplicationController
  ...
  def show
    swapi_id = params['id']
    @species = Species.where(swapi_url: "https://swapi.co/api/species/#{swapi_id}/").first()
  end
  ...
  private
    ...
    def species_params
      params.require(:species).permit(:name, :classification, :designation, :average_height, :skin_colors, :hair_colors, :eye_colors, :average_lifespan, :language, :swapi_url, people: [], films: [], :homeworld)
    end
end
